...
INSERT INTO `distributors` (`f_no`, `f_id`, `f_name`, `f_locallity`, `f_ac`, `last_paid`, `f_phone`, `f_photo`) VALUES
...
--
ALTER TABLE `delivery`
  ADD CONSTRAINT `delivery_ibfk_2` FOREIGN KEY (`r_f_no`) REFERENCES `distributors` (`f_no`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `payment`
  ...
  ADD CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`p_to`) REFERENCES `distributors` (`f_no`) ON DELETE CASCADE ON UPDATE CASCADE;
